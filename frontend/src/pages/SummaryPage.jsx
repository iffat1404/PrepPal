      ...
      <div className="container mx-auto px-6 pb-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-300">Here's your high-level summary</p>
          </div>
          ...
          <div className="mb-8">
            <Link
              to={`/summary/detailed/${sessionId}`}
              className="w-full flex items-center justify-center space-x-3 bg-gray-700/50 hover:bg-gray-700 p-4 rounded-xl border border-gray-600 transition-all text-purple-300 hover:border-purple-500"
            >
              <DocumentMagnifyingGlassIcon className="w-6 h-6" />
              <span className="text-lg font-semibold">View Detailed Question-by-Question Analysis</span>
            </Link>
          </div>
